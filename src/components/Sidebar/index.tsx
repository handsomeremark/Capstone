  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <img src={Logo} alt="Logo" className="w-30 h-auto max-w-full" />
        </NavLink>
        <span className="text-xl font-semibold text-white">GreenCartPH</span>
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/chat"
                  className={`relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('chat') &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
                  ...
                  >
                    <path
                      d="M12 2C6.48 2 2 5.81 2 10C2 11.99 2.97 13.75 4.5 14.94V21L8.11 18.58C9.37 18.88 10.66 19 12 19C17.52 19 22 15.19 22 11C22 6.81 17.52 2 12 2ZM12 17C10.89 17 9.8 16.92 8.77 16.67L6 18V15.92C4.23 14.91 3 13.06 3 11C3 7.73 7.03 5 12 5C16.97 5 21 7.73 21 11C21 14.27 16.97 17 12 17Z"
                      fill="currentColor"
                    />
                  </svg>
                  Chat
              ...
              <li>
                <NavLink
                  to="/products"
                  className={`relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('products') &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
                  ...
                  >
                    <g clipPath="url(#clip0_130_9763)">
                      <path
                        d="M2 1H16C16.55 1 17 1.45 17 2V16C17 16.55 16.55 17 16 17H2C1.45 17 1 16.55 1 16V2C1 1.45 1.45 1 2 1ZM2 0C0.9 0 0 0.9 0 2V16C0 17.1 0.9 18 2 18H16C17.1 18 18 17.1 18 16V2C18 0.9 17.1 0 16 0H2ZM3 3H15V4H3V3ZM3 6H15V7H3V6ZM3 9H15V10H3V9ZM3 12H15V13H3V12ZM3 15H15V16H3V15Z"
                      />
                    </g>
                    <defs>
